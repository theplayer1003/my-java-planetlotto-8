...
- [x] 당첨 번호
    - [x] 당첨 번호는 중복되지 않은 숫자 5개와 보너스 번호 1개를 가진다

- [x] 당첨 금액
    - [x] 1등, 5개 번호, 보너스 번호 false, 100_000_000
    - [x] 2등, 4개 번호, 보너스 번호 true, 10_000_000
    - [x] 3등, 4개 번호, 보너스 번호 false, 1_500_000
    - [x] 4등, 3개 번호, 보너스 번호 true, 500_000
    - [x] 5등, 2개 번호, 보너스 번호 true, 5_000
    - [x] 미당첨, 1개 번호, 보너스 번호 false, 0
...
- Service 가 작업 결과를 반환하는게 아닌 DB에 저장하고 필요하면 조회하는 작업을 구현
- 